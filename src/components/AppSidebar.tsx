...
const allNavigationItems = [
  ...
  { title: 'Bestellen', url: '/voorraad', icon: ClipboardList, group: 'overzicht' as const, locations: ['West', 'Midsland'], managerOnly: false, ownerOnly: false },
  { title: 'Onderweg', url: '/voorraad/onderweg', icon: Truck, group: 'overzicht' as const, locations: ['West', 'Midsland'], managerOnly: false, ownerOnly: false },
  { title: 'Voorraadstand', url: '/voorraad/stand', icon: Boxes, group: 'overzicht' as const, locations: ['West', 'Midsland'], managerOnly: false, ownerOnly: false },
