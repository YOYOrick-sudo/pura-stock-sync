...
export default function StyleGuide() {
  ...
  const ColorBlock = ({ color, name, hex }: { color: string; name: string; hex: string }) => (
    <div style={{ marginBottom: '16px' }}>
      <div style={{ width: '100%', height: '80px', backgroundColor: color, borderRadius: '16px', border: '1px solid hsl(var(--border))', marginBottom: '8px' }} />
      <div style={{ fontFamily: 'Inter, sans-serif', fontSize: '14px', fontWeight: 500, color: 'hsl(var(--foreground))' }}>{name}</div>
      <div style={{ fontFamily: 'Inter, sans-serif', fontSize: '14px', color: 'hsl(var(--muted-foreground))' }}>{hex}</div>
    </div>
  );
  ...
  const Section = ({ title, children }: { title: string; children: React.ReactNode }) => (
    <div style={{ backgroundColor: 'hsl(var(--card))', border: '1px solid hsl(var(--border))', borderRadius: '16px', padding: '32px', marginBottom: '24px' }}>
  ...
  return (
    <SidebarLayout>
      <div style={{ maxWidth: '1200px' }}>
        ...
        <p style={{ fontFamily: 'Inter, sans-serif', fontSize: '16px', color: 'hsl(var(--muted-foreground))', marginBottom: '32px' }}>Complete styling guide voor consistente UI ontwikkeling</p>

        <Section title="Kleuren Palet">
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(200px, 1fr))', gap: '24px' }}>
            <ColorBlock color="hsl(var(--card))" name="Cream" hex="hsl(var(--card))" />
            <ColorBlock color="hsl(var(--secondary))" name="Moonlight" hex="hsl(var(--secondary))" />
            <ColorBlock color="hsl(var(--foreground))" name="Midnight" hex="hsl(var(--foreground))" />
            <ColorBlock color="hsl(var(--muted-foreground))" name="Secondary Text" hex="hsl(var(--muted-foreground))" />
            <ColorBlock color="hsl(var(--primary))" name="Pura Vida Sea" hex="hsl(var(--primary))" />
...
className="border-polar-border"`}
        ...
        <Section title="Border Radius Hiërarchie">
          <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
            <div>
              ...
              <div style={{ width: '200px', height: '40px', backgroundColor: 'hsl(var(--secondary))', borderRadius: '8px', border: '1px solid hsl(var(--border))' }} />
            ...
            <div>
              ...
              <div style={{ width: '200px', height: '60px', backgroundColor: 'hsl(var(--card))', borderRadius: '20px', border: '1px solid hsl(var(--border))' }} />
        ...
        <Section title="Typography">
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            <div>
              <p className="polar-secondary">Secondary text - 14px / 400 (hsl(var(--muted-foreground)))</p>
...
<Button variant="link">Link</Button>`}
        ...
        <Section title="Cards">
          <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
            <div>
              ...
              <div style={{ backgroundColor: 'hsl(var(--card))', border: '1px solid hsl(var(--border))', borderRadius: '16px', padding: '24px', boxShadow: '0 1px 3px rgba(0, 0, 0, 0.06), 0 1px 2px rgba(0, 0, 0, 0.04)' }}>
  ...
  <CardContent>Card content</CardContent>
            ...
            <div>
              ...
              <div style={{ backgroundColor: 'hsl(var(--secondary))', border: '1px solid hsl(var(--border))', borderRadius: '16px', padding: '24px', boxShadow: '0 1px 3px rgba(0, 0, 0, 0.06), 0 1px 2px rgba(0, 0, 0, 0.04)' }}>
  ...
  <div className="flex items-center space-x-2">
    ...
    <Label htmlFor="option1">Option 1</Label>
            ...
            <div>
              ...
              <div style={{ fontSize: '14px', color: 'hsl(var(--muted-foreground))', marginTop: '8px', marginBottom: '16px' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', marginBottom: '24px' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  <div>
                    ...
                    <div style={{ fontSize: '14px', color: 'hsl(var(--muted-foreground))' }}>Receive email updates for new reservations</div>
                  </div>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  <div>
                    ...
                    <div style={{ fontSize: '14px', color: 'hsl(var(--muted-foreground))' }}>Automatically confirm new reservations</div>
                  </div>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  <div>
                    ...
                    <div style={{ fontSize: '14px', color: 'hsl(var(--muted-foreground))' }}>Send SMS reminders 2 hours before reservation</div>
                  </div>
        ...
        <Section title="Spacing & Layout">
          <div style={{ fontFamily: 'Inter, sans-serif', fontSize: '14px', color: 'hsl(var(--foreground))' }}>
            <ul style={{ listStyle: 'none', padding: 0, display: 'flex', flexDirection: 'column', gap: '12px' }}>
              <li>• Card padding: <code style={{ backgroundColor: 'hsl(var(--secondary))', padding: '2px 8px', borderRadius: '4px' }}>32px</code></li>
              <li>• Section spacing: <code style={{ backgroundColor: 'hsl(var(--secondary))', padding: '2px 8px', borderRadius: '4px' }}>24px</code></li>
              <li>• Element spacing: <code style={{ backgroundColor: 'hsl(var(--secondary))', padding: '2px 8px', borderRadius: '4px' }}>16px</code></li>
              <li>• Small spacing: <code style={{ backgroundColor: 'hsl(var(--secondary))', padding: '2px 8px', borderRadius: '4px' }}>8px</code></li>
              <li>• Page padding: <code style={{ backgroundColor: 'hsl(var(--secondary))', padding: '2px 8px', borderRadius: '4px' }}>32px 48px</code></li>
            </ul>
            <CodeBlock
              id="spacing"
...
className="space-x-2"   // 8px horizontal spacing`}
        ...
        <Section title="Dialogs & Modals">
          <p style={{ fontFamily: 'Inter, sans-serif', fontSize: '14px', color: 'hsl(var(--muted-foreground))', marginBottom: '16px' }}>
    ...
    {/* Content */}
            ...
            <div>
              ...
              <ul style={{ fontFamily: 'Inter, sans-serif', fontSize: '14px', color: 'hsl(var(--foreground))', paddingLeft: '20px', display: 'flex', flexDirection: 'column', gap: '8px' }}>
                <li><strong>Container:</strong> Cream background (hsl(var(--card))), 20px border-radius, subtle border, box-shadow</li>
...
// ❌ FOUT
<div className="rounded-[15px] bg-[hsl(var(--secondary))]">
  Non-standard values
</div>`}
              />
            </div>
