      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 mb-8">
          ...
          <p className="text-slate-600">
            Links: de <strong>huidige stijl</strong> met inline styles en oranje accent.<br />
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div>
            ...
            <div className="mt-4 p-3 bg-amber-50 rounded-xl border border-amber-200">
              ...
              <ul className="text-xs text-amber-700 space-y-1">
                <li>• Oranje accent achtergrond</li>
                <li>• Geen shadows</li>
          ...
          <div>
            <div className="mb-4 flex items-center gap-2">
              <div className="w-3 h-3 rounded-full" style={{ backgroundColor: '#E27726' }}></div>
            ...
            <div className="mt-4 p-3 rounded-xl border" style={{ backgroundColor: '#FFF7ED', borderColor: '#FED7AA' }}>
              <h3 className="text-xs font-semibold mb-2" style={{ color: '#E27726' }}>Kenmerken:</h3>
              <ul className="text-xs space-y-1" style={{ color: '#C9630E' }}>
                <li>• Grijze achtergrond (slate-100)</li>
                <li>• Oranje border accent</li>
        ...
        <div className="mt-12">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-lg" style={{ backgroundColor: '#FFF7ED' }}></div>
                  <div>
                    <div className="text-sm font-medium text-slate-900">#FFF7ED</div>
                    <div className="text-xs text-slate-500">Achtergrond</div>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-lg" style={{ backgroundColor: '#FFFFFF' }}></div>
                  <div>
                    <div className="text-sm font-medium text-slate-900">#FFFFFF</div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
              <h3 className="font-semibold mb-4" style={{ color: '#E27726' }}>Pura Vida (Hybride)</h3>
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-lg bg-slate-100 border border-slate-200"></div>
                  <div>
                ...
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-lg bg-white border-2" style={{ borderColor: '#FED7AA' }}></div>
                  <div>
                    <div className="text-sm font-medium text-slate-900">#FED7AA</div>
                    <div className="text-xs text-slate-500">Border accent (on-brand)</div>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-lg" style={{ backgroundColor: '#E27726' }}></div>
                  <div>
                    <div className="text-sm font-medium text-slate-900">#E27726</div>
                    <div className="text-xs text-slate-500">Pura Vida Orange</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        {/* CTA */}
        <div className="mt-12 bg-gradient-to-r from-orange-600 to-amber-600 rounded-2xl p-8 text-center text-white">
          ...
          <div className="flex justify-center gap-4">
            <Link 
              to="/dashboard"
              className="px-6 py-3 bg-white text-orange-700 font-semibold rounded-xl hover:bg-orange-50 transition-colors"
            >
