...
DROP FUNCTION IF EXISTS public.rpc_cijfers_loze_uren_v2(text[], date, date, numeric);
...
GRANT EXECUTE ON FUNCTION public.rpc_cijfers_loze_uren_v2(text[], date, date, numeric, boolean) TO authenticated;
