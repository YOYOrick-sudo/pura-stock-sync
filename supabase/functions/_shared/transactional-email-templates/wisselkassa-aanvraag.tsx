...
export const template = {
  ...
  previewData: { vestiging: 'West', aanvrager: 'Sanne', tijdstip: '6 sep 2026, 14:53', toelichting: 'Wisselgeld is bijna op' },
...
const noteStyle = { fontSize: '15px', color: '#0F172A', lineHeight: '1.6', margin: '0 0 16px', padding: '16px', backgroundColor: '#F1F5F9', borderRadius: '12px' }
